...
export function UserCard({ user }: UserCardProps) {
  return (
    <Link
      ...
      className="group"
    >
      <div className="relative flex flex-col items-center p-6 bg-card border border-border rounded-none transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 group-hover:bg-accent/5 overflow-hidden">
